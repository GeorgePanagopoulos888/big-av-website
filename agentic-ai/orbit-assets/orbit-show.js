...
const CONTINUOUS_SHOW_AUDIO_PATH = "orbit-assets/bradley-voice/bradley-show-mobile.m4a";
...
const BRADLEY_SCRIPT = [
  ...
  },
  {
    ...
    // The whip/swap starts when beat_10-p1.m4a begins saying "accelerates.".
    orbitSwapOnPart: 1,
    orbitSwapDelayMs: 40,
...
function bakedVoicePath(beatId, partIndex, partCount) {
  if (partCount > 1) return `orbit-assets/bradley-voice/${beatId}-p${partIndex}.m4a`;
  return `orbit-assets/bradley-voice/${beatId}.m4a`;
}
